    ...
    <div className={styles.weather}>
      <div>
        ...
        <div className={styles.text}>
          <div className={styles.mainText}> {data.indoor_temp}°C</div>
      ...
      <div>
        ...
        <div className={styles.text}>
          <div className={styles.mainText}> {data.outdoor_temp}°C</div>
          <div className={styles.minorText}>
            {" "}
      ...
      <div>
        ...
        <div className={styles.text}>
          <div className={styles.mainText}> {data.cpu_temp}°C</div>
          <div className={styles.minorText}>
            {" "}
